...
public class ReactiveHttpClient {
    ...
    /**
     * Reactor Context key {@link com.tiltedev.springreactive.controller.RequestLoggingFilter}
     * writes the inbound request id under.
     */
                                    ...
                                    Flux.error(
                                            new ApiTimeoutException(
                                                    ...
                                                    "Request timed out after "
                                                            ...
                                                            + "ms")))
                            .doOnSubscribe(
                                    s -> log.debug("[{}] -> {} (flux) {}", requestId, method, path))
                            ...
                            .onErrorMap(
                                    ...
                                    e -> {
                                        log.error(
                                                ...
                                                path,
                                                e.getMessage());
                                        return new ApiIncompleteResponseException(
